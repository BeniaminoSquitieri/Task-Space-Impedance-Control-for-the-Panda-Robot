...
struct has_fixed_size<cartesian_control_msgs::action::FollowCartesianTrajectory_Goal>
  : std::integral_constant<bool, has_fixed_size<moveit_msgs::msg::CartesianTrajectory>::value> {};

template<>
struct has_bounded_size<cartesian_control_msgs::action::FollowCartesianTrajectory_Goal>
  : std::integral_constant<bool, has_bounded_size<moveit_msgs::msg::CartesianTrajectory>::value> {};
